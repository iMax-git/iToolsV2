...
namespace iToolsV2.Other
{
    ...
    {
        private List<string> _timeCycle = new List<string>()
        {
          "underwater",
          "underwater_deep",
          "NoAmbientmult",
          ...
          "WATER_resevoir",
          "WATER_hills",
          "WATER_militaryPOOP","NEW_ornate_bank",
          ...
          "Glasses_BlackOut",
          "winning_room",
          "mugShot_lineup","MPApartHigh_palnning", 
          "v_dark",
          "polluted",
          "lightning",
          "torpedo",
          "NEW_shrinksOffice","Facebook_NEW",
          "NEW_trevorstrailer",
          "New_sewers",
          "facebook_serveroom",
          "V_Office_smoke_Fire",
        ...
        public void loadTimeCycle(String timecycle)
        {
            API.SetTimecycleModifier(timecycle);
            API.SetTimecycleModifierStrength(Strength);
        }
        
        public void ClearTimeCycle()
        {
            API.ClearTimecycleModifier();
            API.ClearExtraTimecycleModifier();
            API.ResetExtraTimecycleModifierStrength();
        }
        
        public List<string> getTimeCycles() => _timeCycle;
